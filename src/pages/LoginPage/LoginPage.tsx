...
import { Clock, Eye, EyeOff, Github } from "lucide-react";
...
export const LoginPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Navegação direta para o app (sem autenticação real por enquanto)
    navigate("/app");
  };

  return (
    <div className="login-page min-h-screen bg-surface-page">
      {/* Background Pattern */}
